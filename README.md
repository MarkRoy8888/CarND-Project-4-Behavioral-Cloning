...
2.Improve model- The model architecture is base on NVIDIA's. It has some space to improve.<br/>
3.Data clear- some data maybe are bad(bad-control,wrong-control) which need  delete to improve model.<br/>
